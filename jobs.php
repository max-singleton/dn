            ...
            <div class="col-md-8">
                ...
                <div class="alert alert-info col-md-12">
                    <ul>
                        ...
                        <hr>
                        <li>
                            <p>Инженер производственно-технического отдела. Опыт в сфере ЖКХ (обслуживание МКД), знание программы Smeta.RU. Должен знать технологию и способы ведения ремонтно-строительных работ, строительные нормы и правила, сметные нормативные документы, порядок приемки работ, объектов и методы контроля их качества. Заработная плата 20 000 рублей.</p>
                        </li>
                        <hr>
                        <li>
