            ...
            <div class="top-footer row">
                    <div class="col-xl-9 col-md-10  offset-md-1 offset-xl-0 p0 menu-footer">
                        ...
                        <div class="col-xl-4 col-md-6  menu-footer-items">
                                <a href="#" class="podmenu-1">О компании</a>
                                <div class="row podmenu__col">
                                    <div class="col-xl-6 podmenu__links p0">
                                        <a href="#" class="podmenu">Новости</a>
                                        <a href="#" class="podmenu">Объявления</a>
                                        <a href="#" class="podmenu">Услуги</a>
                                    </div>
                                    <div class="col-xl-6 podmenu__links p0 ">
                                        <a href="#" class="podmenu">Вакансии</a>
                                        <a href="#" class="podmenu">Платные работы</a>
                                        <a href="#" class="podmenu">Документы</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6  menu-footer-items">
                                    <a href="#" class="podmenu-1">Наши дома</a>
                                    <div class="podmenu__links">
                                        <a href="#" class="podmenu">ООО "Достояние"</a>
                                        <a href="#" class="podmenu">ООО "Наследие"</a>
                                    </div>
                                </div>
                            
                        <div class="col-xl-3 col-md-6  menu-footer-items">
                                <a href="#" class="podmenu-1">Контакты</a>
                                <div class="podmenu__links">
                                    <a href="#" class="podmenu">График работы</a>
                                    <a href="#" class="podmenu"> Реквизиты</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-11 offset-md-1 col-xs-12 offset-xl-0 btn-but">
                            <div class="col-xl-12 col-md-5 btn-but-1"> <a href=""style="color: #fff">Задать вопрос</a> </div>
                            <div class="col-xl-12 col-md-5 push-md-1 push-xl-0 btn-but-2"><a href="" style="color: #fff">Личный кабинет</a></div>
                        </div>
            </div>
