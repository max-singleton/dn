<div class="mobile-menu">
        <div class="mobile-menu__menu">
            <div class="mobile-menu__nav">
                ...
                <li class="mobile-menu__nav-items"><a href="">О КОМПАНИИ</a></li>
                <li class="mobile-menu__nav-items"><a href="/inner.php">КОНТАКТНАЯ ИНФОРМАЦИЯ</a></li>
                <li class="mobile-menu__nav-items"><a href="">ДОМА В ОБСЛУЖИВАНИИ</a></li>
                <li class="mobile-menu__nav-items"><a href="">ЗАДАТЬ ВОПРОС?</a></li>
                <li class="mobile-menu__nav-items"><a href="">ЛИЧНЫЙ КАБИНЕТ</a></li>
            </div>
            <div class="mobile-menu__nav mobile-menu__auth">
                <li class="mobile-menu__nav-items"><a href="/lk.php">ВХОД В
                    ЛИЧНЫЙ КАБИНЕТ</a></li>
                <li class="mobile-menu__nav-items"><a href="">РЕГИСТРАЦИЯ</a> </li>
            </div>
